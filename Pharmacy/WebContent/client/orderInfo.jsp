...
<body class="main">
	...
	<div id="divpagecontent">
		<table width="100%" border="0" cellspacing="0">
			<tr>
				<td style="position: absolute;width: 900px;top: 25%;">
					...
					<table cellspacing="0" class="infocontent" >
						<tr>
							<td>
								<table width="100%" border="0" cellspacing="0" style="background-color: #EEEEEE;">
									<tr>
										<td>
											<p>订单编号:${order.id}</p>
										</td>
										...
										<td>
											...
											<p style="text-align:right">
												<a href="${pageContext.request.contextPath}/client/pay.jsp?id=${order.id}&money=${order.money}">
													<img src="${pageContext.request.contextPath }/client/images/pay.png" width="85" height="70" border="0" /><!-- gif53_030.gif --> 
												</a>
											</p>
											</c:if>
										</td>
