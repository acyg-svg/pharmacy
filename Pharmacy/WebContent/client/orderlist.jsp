...
<%@taglib prefix="p" uri="http://www.cyg.cn/tag"%>
...
<body class="main">
	...
	<div id="divpagecontent">
		<table width="100%" border="0" cellspacing="0">
			<tr>
				<td style="position: absolute;width: 400px;top: 23%;"  width="25%">
...
<%-- 						<tr>
							<td class="listtd">
								...
								&nbsp;&nbsp;&nbsp;&nbsp; 
								<a href="${pageContext.request.contextPath }/client/modifyuserinfo.jsp" style="position: absolute;left: 35%;">用户信息修改</a>
							</td>
						</tr> --%>
						<tr>
							<td class="listtd">
								...
								&nbsp;&nbsp;&nbsp;&nbsp; 
								<a href="${pageContext.request.contextPath}/findOrderByUser" style="position: absolute;left: 35%;">订单查询</a>
							</td>
						</tr>
						<tr>
							<td class="listtd">
								...
								&nbsp;&nbsp;&nbsp;&nbsp; 
								<a href="${pageContext.request.contextPath}/logout" style="position: absolute;left: 35%;">用户退出</a>
							</td>
						</tr>
					</table>
				</td>
				<td style="position: absolute;width: 800px;top: 25%;left: 45%;">
					...
					<table cellspacing="0" class="infocontent" style="background-color: gray;" >
						<tr>
