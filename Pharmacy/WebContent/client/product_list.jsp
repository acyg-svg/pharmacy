...
<%@ page import="sise.cyg.bean.PageBean" %>
...
<body class="main">
	...
	<div id="divpagecontent">
		<table width="100%" border="0" cellspacing="0">
			<tr>
				<td>
					<div style="text-align:right; margin:5px 10px 5px 0px; position:absolute;left:60%;top:26%;">
					...
					<table cellspacing="0" class="listcontent" style="background-color:#EEEEEE; position:absolute; width:500px; top:30%;">
						<tr>
							<td>
								<h1>商品列表</h1>
								<hr />
										...
										<c:forEach items="${bean.ps}" var="p" varStatus="vs">
											<td>
												...
												<div class="divlisttitle">
													<a href="${pageContext.request.contextPath}/findProductById?id=${p.id}">商品名称： ${p.name}<br />价格：￥${p.price} </a>
												</div>
											</td>
										</c:forEach>
									</tr>
