...
<body class="main">
	...
	<div id="divpagecontent">
		<table width="100%" border="0" cellspacing="0">
			<tr>
				<td style="position: absolute;width: 800px;top: 25%;"><div style="text-align:right; margin:5px 10px 5px 0px">
					...
					<form id="orderForm" action="${pageContext.request.contextPath}/createOrder" method="post">
						<table cellspacing="0" class="infocontent" style="background-color: #EEEEEE;">
							<tr>
								<td>
								<table width="100%" border="0" cellspacing="0">
										<tr>
											<td><!-- <img src="images/buy2.gif" width="635" height="38" /> -->
												<p>你好，${user.username}！欢迎您来到结算中心</p>
											</td>
										</tr>
										<tr>
											<td>
												...
												<p style="text-align:right">
													<img src="images/input.png" width="40" height="51" border="0" onclick="checkOnSubmit();"/><!-- gif53_029.gif -->
												</p>
											</td>
										</tr>
									</table>
