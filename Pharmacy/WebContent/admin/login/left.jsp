...
<head>
	...
	<body>
		...
		<table width="100%" border="0">
			  ...
			  <tr>
			  	<td><a href="${pageContext.request.contextPath}/admin/products/download.jsp" target="mainFrame" class="left_list">卖出详情下载</a></td>
			  </tr>
			  <tr>
			  	<td><a href="${pageContext.request.contextPath}/findOrders" target="mainFrame" class="left_list">订单管理</a></td>
			  </tr>
			  <tr>
			  	<td><a href="${pageContext.request.contextPath}/manager/ListNoticeServlet" target="mainFrame" class="left_list">通知管理</a></td>
			  </tr>
		</table>
	</body>
</html>
