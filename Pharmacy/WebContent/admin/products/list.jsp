...
<body>
	...
	<form id="Form1" name="Form1"
		...
		method="post">
		<table cellSpacing="1" cellPadding="0" width="100%" align="center" bgColor="#DDB1E7" border="0">
			<TBODY>
				<tr>
					<td class="ta_01" align="center" bgColor="#DDB1E7">
						<strong>按  类  别  查 询</strong>
					</td>
				</tr>
				<tr>
					<td>
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<select name="category" id="category">
										...
										<option value="抗疫物资">抗疫物资</option>
										<option value="中药药材">中药药材</option>
...
<!-- 										<option value="消毒用品">消毒用品</option>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#DDB1E7"><strong>商 品 列 表</strong>
					</TD>
				</tr>
				<tr>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #DDB1E7">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%">
									    <a href="${pageContext.request.contextPath}/findProductById?id=${p.id}&type=admin">
											<img src="${pageContext.request.contextPath}/admin/images/edit.png" border="0" style="CURSOR: hand"> 
										</a>
									</td>
									<td align="center" style="HEIGHT: 22px" width="7%">
