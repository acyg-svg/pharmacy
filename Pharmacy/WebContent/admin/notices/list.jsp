				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #DDB1E7">
								<td align="center" width="12%">通知编号</td>
								<td align="center" width="12%">通知标题</td>
								<td align="center" width="24%">通知内容</td>
