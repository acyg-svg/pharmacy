...
import sise.cyg.bean.User;
import sise.cyg.dao.UserDao;
import sise.cyg.exception.ActiveUserException;
import sise.cyg.exception.RegisterException;
import sise.cyg.utils.MailUtils;
...
public class UserService {
	...
	public void register(User user) throws RegisterException {
		...
		try {
			dao.addUser(user);
			// 发送激活邮件
			String emailMsg = "感谢您注册本站会员，点击"
					+ "<a href=http://127.0.0.1:8080/Pharmacy/activeUser?activeCode="
					+ user.getActiveCode() + ">&nbsp;激活&nbsp;</a>即可。"
